...
void Simplex::MyEntity::Init(void)
{
	...
	m_bInMemory = false;
	m_bSetAxis = false;
	m_pDisableModelRender = false;
	m_pDisableRigidBody = false;
	m_pModel = nullptr;
...
void Simplex::MyEntity::Swap(MyEntity& other)
{
	...
	std::swap(m_pDisableModelRender, other.m_pDisableModelRender);
	std::swap(m_pDisableRigidBody, other.m_pDisableRigidBody);
...
Simplex::MyEntity::MyEntity(MyEntity const& other)
{
	...
	m_pDisableRigidBody = other.m_pDisableRigidBody;
	m_pDisableModelRender = other.m_pDisableModelRender;
...
void Simplex::MyEntity::AddToRenderList(bool a_bDrawRigidBody)
{
	...
	//draw model
	if(!m_pDisableModelRender)
		m_pModel->AddToRenderList();

	//draw rigid body
	if (a_bDrawRigidBody && !m_pDisableRigidBody)
...
bool Simplex::MyEntity::IsColliding(MyEntity* const other)
{
	...
	if (m_pDisableRigidBody || other->m_pDisableRigidBody)
		return false;
...
void Simplex::MyEntity::DisableRigidBody()
{
	m_pDisableRigidBody = true;
}
void Simplex::MyEntity::HideModelRender()
{
	m_pDisableModelRender = true;
}
void Simplex::MyEntity::ShowModelRender()
{
	m_pDisableModelRender = false;
}